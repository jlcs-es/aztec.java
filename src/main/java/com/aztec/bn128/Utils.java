...
public class Utils {
    ...
    public static final String[] CRS = new String[] { "0x" + hXHex, "0x" + hYHex, t2[0], t2[1], t2[2], t2[3] };

    public static final BigInteger compressionMask = new BigInteger(
     ...
     *   The first 254 bits define the x-coordinate. The most significant bit defines whether the
     *   y-coordinate is odd
     * @param compressedHex 256-bit compressed coordinate in Hex String form
     * @return BN128Fp point
     */
    public static BN128Fp decompressHex(String compressedHex) throws Exception {
        var compressed = new BigInteger(Hex.cleanHexPrefix(compressedHex), 16);
